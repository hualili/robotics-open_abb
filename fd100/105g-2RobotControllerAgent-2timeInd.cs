//-----------------------------------------------------------------------------------/
// program    : RobotControllerAgent-2timeInd.cv                                     /
...
//                 gain factor                                                       /
//              2. reward_flag set to "false" to use base-line                       /
//                 algorithm with time index (line 260)                              /
//-----------------------------------------------------------------------------------/ 
using System;
...
public class RobotControllerAgent : Agent
{
   ...
   private string path = @"/home/chee/Documents/RobotArmMLAgentUnity_original/distance/distance-base-timeInd-01.csv"; // CV 2021-5-14: File path for CSV file
   ...
   public override void OnActionReceived(float[] vectorAction)
   {
      ...
      if (trainingMode)
      {
         ...
         bool reward_flag = false; // 2021-5-17 CV: flag for using original (false) or our reward function (true)
         float reward;
